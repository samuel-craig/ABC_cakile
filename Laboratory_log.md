...
- See confusion tables, followed by LDA below: (1) *C. edentula* pooled scenarios  (2) 1,000,0000 datasets, all *C. edentula* scenarios
1. [*C. edentula* pooled scenarios](https://github.com/samuel-craig/ABC_cakile/blob/main/Output/edentula_A_B_C_v.2/edentula_A_B_C_v.2_scenario_choice/modelchoice_out.confusion)
